...
**findall(UnIndividuoOVariable, Consulta, Conjunto de salida)**

### Ejemplo

Contamos con esta base de conocimiento y queremos saber la cantidad de hijos que tiene homero
...
% Con el findall entonces seria asi
